Feature: Status Operacional do Restaurante
  ...
  Background:
    ...
    And que o "restaurante" cujo "nome" é "Gosto bom" "existe" na tabela "restaurantes" do banco de dados
  ...
  Scenario: Fechamento automático por horário
    ...
    Then o sistema deve atualizar o "restaurante" cujo "id" é "123" com o novo "status" para "Fechado" na tabela "restaurantes" do banco de dados
  ...
  Scenario: Abertura automática por horário
    ...
    Then o sistema deve atualizar o "restaurante" cujo "id" é "123" com o novo "status" para "Aberto" na tabela "restaurantes" do banco de dados
